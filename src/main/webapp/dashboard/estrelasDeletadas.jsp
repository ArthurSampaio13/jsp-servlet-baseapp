...
<%
    if (session.getAttribute("user") != null) {
        ...
        int totalEstrelas = estrelaService.countEstrelasDesativadas();
        int totalPages = (int) Math.ceil((double) totalEstrelas / pageSize); // Total de páginas

        // Lista de estrelas para a página atual
        List<EstrelaDTO> estrelas = estrelaService.listAllEstrelasDesativadasPaginada(pageNumber, pageSize);
%>
